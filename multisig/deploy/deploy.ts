...
async function main() {
  ...
  console.log("Account balance:", (await deployer.getBalance()).toString());
    ...
    await spc.setOwner(0x2Ba31969190FC59B674d054CA112230EeC06E09E);
    await pool.setOwner(0x2Ba31969190FC59B674d054CA112230EeC06E09E);
    await router.setOwner(0x2Ba31969190FC59B674d054CA112230EeC06E09E);
    await ico.setOwner(0x2Ba31969190FC59B674d054CA112230EeC06E09E);
